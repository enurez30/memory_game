...
) = kotlinx.coroutines.flow.combine(listOf(f1, f2, f3, f4, f5, f6, f7)) {
    transform(
        it[0] as T1,
        it[1] as T2,
        it[2] as T3,
...
inline fun <reified T1, reified T2, reified T3, reified T4, reified T5, reified T6, reified T7, reified T8, R> combine(
    f1: Flow<T1>,
    f2: Flow<T2>,
    f3: Flow<T3>,
    f4: Flow<T4>,
...
) = kotlinx.coroutines.flow.combine(listOf(f1, f2, f3, f4, f5, f6, f7, f8)) {
    transform(
        it[0] as T1,
        it[1] as T2,
        it[2] as T3,
