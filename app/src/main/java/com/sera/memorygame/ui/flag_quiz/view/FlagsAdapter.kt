...
class FlagsAdapter : ListAdapter<FlagQuizSingleObject, RecyclerView.ViewHolder>(FlagComparator) {
    ...
    object FlagComparator : DiffUtil.ItemCallback<FlagQuizSingleObject>() {
